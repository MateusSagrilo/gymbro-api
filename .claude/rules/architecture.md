Git
SEMPRE use Conventional Commits para mensagens de commit. Exemplo: feat: add start workout session endpoint, fix: workout plan validation, docs: update architecture rules.
